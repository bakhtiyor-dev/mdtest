            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-users"></i> {{ trans('admin.user.actions.index') }}
                            </h4>
                            <h5>Общее количество пользователей: {{$usersCount}}</h5>
                        </div>
                        ...
                        @else
                            <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                               href="{{ url('admin/users/create') }}" role="button"><i
                                        class="fa fa-plus"></i>&nbsp; {{ trans('admin.user.actions.create') }}</a>
