<div class="form-group row align-items-center"
    ...
    <label for="title" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.department.columns.title') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.title" v-validate="'required'" data-vv-as="название" @input="validate($event)"
               ...
               id="title" name="title" placeholder="{{ trans('admin.department.columns.title') }}">
