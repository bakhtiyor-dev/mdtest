...
@section('title', trans('admin.test-category.actions.index'))

@section('body')

    <test-category-listing
            :data="{{ $data->toJson() }}"
            :url="'{{ url('admin/test-categories') }}'"
            inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-list"></i> {{ trans('admin.test-category.actions.index') }}
                            </h4>
                        </div>
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/test-categories/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.test-category.actions.create') }}
                        </a>
                    </div>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.test-category.columns.id') }}</th>
                                    <th is='sortable'
                                        :column="'title'">{{ trans('admin.test-category.columns.title') }}</th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/test-categories/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/test-categories/create') }}"
                                   role="button"><i
                                            class="fa fa-plus"></i>&nbsp; {{ trans('admin.test-category.actions.create') }}
                                </a>
                            </div>
                        </div>
                    </div>
