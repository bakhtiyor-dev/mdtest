...
@section('body')
    ...
    <exam-user-attempt-listing
            :data="{{ $data->toJson() }}"
            :url="'{{ url('admin/exam-user-attempts') }}'"
            inline-template>
                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="pull-left">
                            ...
                            <h5>Общее кол-во попыток: {{$attemptsCount}}</h5>
                        </div>

                        <form action="{{url('/admin/exam-user-attempts/print')}}"
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="11">
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/exam-user-attempts/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
