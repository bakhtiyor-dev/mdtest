...
@section('title', "Подключенные пользователи")

@section('body')

    <exam-user-listing
            :data="{{ $data->toJson() }}"
            :url="'{{ route('admin/exam-users/index',$exam) }}'"
            inline-template>

        <div class="row">
            <div class="col">
                <a href="{{url('/admin/exams')}}" class="btn btn-primary mb-2">
                    ...
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            ...
                            <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                               href="{{ route('admin/exam-users/create',$exam) }}" role="button"><i
                            ...
                            <form @submit.prevent="">
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex">
                                            <p class="mr-4">
                                                <b class="text-monospace">ID экзамена: {{$exam->id}}</b>
                                            </p>
                                            <div>
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="9">
                                            <span class="align-middle font-weight-light text-dark">{{ trans('brackets/admin-ui::admin.listing.selected_items') }} @{{ clickedBulkItemsCount }}.  <a
                                                        ...
                                                        @click="onBulkItemsClickedAll('{{route('admin/exam-users/index',$exam)}}')"
                                ...
                                <tr v-for="(item, index) in collection" :key="item.id"
                                    ...
                                    <td>
                                        <div class="row no-gutters">
                                            <a :href="'/admin/exam-users/exam/{{$exam->id}}/users/'+item.user.id"
