...
@section('title', trans('admin.organisation.actions.index'))

@section('body')

    <organisation-listing
            :data="{{ $data->toJson() }}"
            :url="'{{ url('admin/organisations') }}'"
            inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-building-o"></i> {{ trans('admin.organisation.actions.index') }}
                            </h4>
                            <h5>Общее количество подразделений: {{$organisationsCount}}</h5>
                        </div>

                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/organisations/create') }}" role="button"><i
                                    class="fa fa-plus"></i>&nbsp; {{ trans('admin.organisation.actions.create') }}</a>
                    </div>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.organisation.columns.id') }}</th>
                                    <th is='sortable'
                                        :column="'title'">{{ trans('admin.organisation.columns.title') }}</th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/organisations/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/organisations/create') }}"
                                   role="button"><i
                                            class="fa fa-plus"></i>&nbsp; {{ trans('admin.organisation.actions.create') }}
                                </a>
                            </div>
                        </div>
                    </div>
