...
class FillPermissionsForExamUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExamUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.exam-user',
            'admin.exam-user.index',
            'admin.exam-user.create',
            'admin.exam-user.show',
            'admin.exam-user.edit',
            'admin.exam-user.delete',
            'admin.exam-user.bulk-delete',
        ]);
