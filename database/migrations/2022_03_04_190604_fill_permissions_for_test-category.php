...
class FillPermissionsForTestCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTestCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.test-category',
            'admin.test-category.index',
            'admin.test-category.create',
            'admin.test-category.show',
            'admin.test-category.edit',
            'admin.test-category.delete',
            'admin.test-category.bulk-delete',
        ]);
