...
class FillPermissionsForExamUserAttempt extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExamUserAttempt constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.exam-user-attempt',
            'admin.exam-user-attempt.index',
            'admin.exam-user-attempt.create',
            'admin.exam-user-attempt.show',
            'admin.exam-user-attempt.edit',
            'admin.exam-user-attempt.delete',
            'admin.exam-user-attempt.bulk-delete',
        ]);
