...
class FillPermissionsForRatingSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRatingSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rating-setting',
            'admin.rating-setting.index',
            'admin.rating-setting.create',
            'admin.rating-setting.show',
            'admin.rating-setting.edit',
            'admin.rating-setting.delete',
            'admin.rating-setting.bulk-delete',
        ]);
