<div class="form-group row align-items-center">
    ...
    <div class="col-lg-6">
        <v-select v-validate="'required'"
                  ...
                  :options="<?php echo e($organisations->toJson()); ?>"
                  label="title"
...
<div class="form-group row align-items-center">
    ...
    <div class="col-lg-6">
        <v-select v-validate="'required'"
                  ...
                  data-vv-as="отдел"
                  :options="<?php echo e($departments->toJson()); ?>"
                  label="title"
...
<div class="form-group row align-items-center"
    ...
    <label for="title" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.exam.columns.title')); ?></label>
...
<div class="form-group row align-items-center"
    ...
    <label for="start_date" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.exam.columns.start_date')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div class="input-group input-group--custom">
            ...
            <datetime v-model="form.start_date" :config="datetimePickerConfig"
                      ...
                      placeholder="<?php echo e(trans('brackets/admin-ui::admin.forms.select_date_and_time')); ?>"></datetime>
        </div>
...
<div class="form-group row align-items-center"
    ...
    <label for="end_date" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.exam.columns.end_date')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
...
<div class="form-group row align-items-center"
    ...
    <label for="time" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.exam.columns.time')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="number" v-model="form.time" v-validate="'required|integer'" data-vv-as="время"
               ...
               id="time" name="time" placeholder="<?php echo e(trans('admin.exam.columns.time')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="attempts_count" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.exam.columns.attempts_count')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="number" v-model="form.attempts_count" v-validate="'required|integer'" data-vv-as="кол-во попыток"
               ...
               id="attempts_count" name="attempts_count" placeholder="<?php echo e(trans('admin.exam.columns.attempts_count')); ?>">
...
<div class="form-group row align-items-center">
    ...
    <div class="col-lg-6">
        <v-select v-validate="'required'"
                  ...
                  :options="<?php echo e($ratingSettings->toJson()); ?>" label="title"
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="can_complete_untill_all_answered">
            <?php echo e(trans('admin.exam.columns.can_complete_untill_all_answered')); ?>
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="can_return_to_passed_question">
            <?php echo e(trans('admin.exam.columns.can_return_to_passed_question')); ?>
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="can_skip_question">
            <?php echo e(trans('admin.exam.columns.can_skip_question')); ?>
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="enable_explanation">
            <?php echo e(trans('admin.exam.columns.enable_explanation')); ?>
...
<div>
    ...
    <test-category-count :test_categories="<?php echo e($testCategories->toJson()); ?>"
                         v-model="form.test_category_count"></test-category-count>
</div>


<?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/exam/components/form-elements.blade.php ENDPATH**/ ?>