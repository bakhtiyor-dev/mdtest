<?php $__env->startSection('title', trans('admin.organisation.actions.index')); ?>

<?php $__env->startSection('body'); ?>

    <organisation-listing
            :data="<?php echo e($data->toJson()); ?>"
            :url="'<?php echo e(url('admin/organisations')); ?>'"
            inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-building-o"></i> <?php echo e(trans('admin.organisation.actions.index')); ?>

                            </h4>
                            <h5>Общее количество подразделений: <?php echo e($organisationsCount); ?></h5>
                        </div>

                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="<?php echo e(url('admin/organisations/create')); ?>" role="button"><i
                                    class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.organisation.actions.create')); ?></a>
                    </div>
                        ...
                        <div class="card-block">
                                ...
                                <div class="row justify-content-md-between">
                                    <div class="col col-lg-7 col-xl-5 form-group">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Фильтр по названиям"
                                                   v-model="search"
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'"><?php echo e(trans('admin.organisation.columns.id')); ?></th>
                                    <th is='sortable'
                                        :column="'title'"><?php echo e(trans('admin.organisation.columns.title')); ?></th>
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                            <span class="align-middle font-weight-light text-dark"><?php echo e(trans('brackets/admin-ui::admin.listing.selected_items')); ?> {{ clickedBulkItemsCount }}.  <a
                                                        ...
                                                        @click="onBulkItemsClickedAll('/admin/organisations')"
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/organisations/bulk-destroy')"><?php echo e(trans('brackets/admin-ui::admin.btn.delete')); ?></button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="<?php echo e(url('admin/organisations/create')); ?>"
                                   role="button"><i
                                            class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.organisation.actions.create')); ?>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/organisation/index.blade.php ENDPATH**/ ?>