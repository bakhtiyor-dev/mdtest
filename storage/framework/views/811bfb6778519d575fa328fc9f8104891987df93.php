...
<?php $__env->startSection('title', trans('admin.department.actions.index')); ?>

<?php $__env->startSection('body'); ?>

    <department-listing
            :data="<?php echo e($data->toJson()); ?>"
            :url="'<?php echo e(url('admin/departments')); ?>'"
            inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-cubes"></i> <?php echo e(trans('admin.department.actions.index')); ?>

                            </h4>
                            <h5>Общее количество отделов: <?php echo e($departmentsCount); ?></h5>
                        </div>

                        <div class="pull-right">
                            <a class="btn btn-primary btn-spinner btn-sm m-b-0"
                               href="<?php echo e(url('admin/departments/create')); ?>" role="button"><i
                                        class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.department.actions.create')); ?></a>
                        </div>
                        ...
                        <div class="card-block pt-0">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'"><?php echo e(trans('admin.department.columns.id')); ?></th>
                                    <th is='sortable'
                                        :column="'title'"><?php echo e(trans('admin.department.columns.title')); ?></th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="7">
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/departments/bulk-destroy')"><?php echo e(trans('brackets/admin-ui::admin.btn.delete')); ?></button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="<?php echo e(url('admin/departments/create')); ?>"
                                   role="button"><i
                                            class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.department.actions.create')); ?>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/department/index.blade.php ENDPATH**/ ?>