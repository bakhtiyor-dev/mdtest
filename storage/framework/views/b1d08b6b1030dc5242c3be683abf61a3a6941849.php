<div class="form-group row align-items-center"
    ...
    <label for="fullname" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.fullname')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.fullname" v-validate="'required'" data-vv-as="учетное имя"
               ...
               id="fullname" name="fullname" placeholder="<?php echo e(trans('admin.user.columns.fullname')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="position" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.position')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.position" class="form-control" id="position" name="position"
               placeholder="<?php echo e(trans('admin.user.columns.position')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="department" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.department')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.department" id="department" name="department" class="form-control"
               placeholder="<?php echo e(trans('admin.user.columns.department')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="email" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.email')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.email" v-validate="'required|email'" data-vv-as="электронная почта"
               ...
               id="email" name="email" placeholder="<?php echo e(trans('admin.user.columns.email')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="organisation" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.organisation')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.organisation" class="form-control"
               id="organisation" name="organisation" placeholder="<?php echo e(trans('admin.user.columns.organisation')); ?>">
...
<div class="form-group row align-items-center"
    ...
    <label for="password" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.password')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="password" v-model="form.password" v-validate="'min:7'" data-vv-as="пароль"
               ...
               id="password" name="password" placeholder="<?php echo e(trans('admin.user.columns.password')); ?>" ref="password">
...
<div class="form-group row align-items-center"
    ...
    <label for="password_confirmation" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.user.columns.password_repeat')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="password" v-model="form.password_confirmation" v-validate="'confirmed:password|min:7'"
               ...
               placeholder="<?php echo e(trans('admin.user.columns.password')); ?>" data-vv-as="password">
...
<?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/user/components/form-elements.blade.php ENDPATH**/ ?>