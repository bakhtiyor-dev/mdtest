                ...
                <div class="row m-0">
                    <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                        <div class="border-right p-2">
                            <img src="<?php echo e(asset('images/exam.svg')); ?>" class="img-fluid" alt="branding logo">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12 p-0">
                        <div class="card rounded-0 mb-0 px-2 pb-4 pt-2">
                            <div class="card-header">
                                <div>
                                    <img src="<?php echo e(asset('images/plane.png')); ?>" style="height: 50px;" class="img-fluid mb-2">
...
unset($__errorArgs, $__bag); ?>"
                                                   name="username" placeholder="Email" value="<?php echo e(old('username')); ?>"
...
<?php echo $__env->make('client.layouts/fullLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/auth/login.blade.php ENDPATH**/ ?>