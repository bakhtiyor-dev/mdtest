							...
							<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/login')); ?>" novalidate>
								...
								<div class="auth-header pb-2">
									<div class="text-center">
										<img src="<?php echo e(asset('images/plane.png')); ?>" style="height: 40px"  class="img-fluid mb-4" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('brackets/admin-ui::admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/vendor/brackets/admin-auth/admin/auth/login.blade.php ENDPATH**/ ?>