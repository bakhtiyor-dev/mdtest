...
<?php $__env->startSection('title', "Подключить пользователей"); ?>

<?php $__env->startSection('body'); ?>

    <a href="<?php echo e(route('admin/exam-users/index',$exam)); ?>" class="btn btn-primary mb-3">
    ...
    <form class="form-horizontal form-create"
          method="post"
          action="<?php echo e(route('admin/exam-users/store',$exam)); ?>">

        <?php echo csrf_field(); ?>

        <user-listing
                :data="<?php echo e($data->toJson()); ?>"
                :url="'<?php echo e(route('admin/exam-users/create',$exam)); ?>'"
                inline-template>
                                ...
                                <form @submit.prevent="">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <v-select :options="<?php echo e($positions->toJson()); ?>"
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/exam-user/create.blade.php ENDPATH**/ ?>