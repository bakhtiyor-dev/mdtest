<div class="form-group row align-items-center">
    ...
    <div class="col-lg-6">
        ...
        <v-select :options="<?php echo e($categories->toJson()); ?>"
                  v-validate="'required'"
                  label="title"
...
<div class="form-group row align-items-center"
    ...
    <label for="body" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.test.columns.body')); ?></label>
...
<div class="form-group row align-items-center"
    ...
    <label for="answers_type" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'"><?php echo e(trans('admin.test.columns.answers_type')); ?></label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="status">
            <?php echo e(trans('admin.test.columns.status')); ?>
...
</div><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/test/components/form-elements.blade.php ENDPATH**/ ?>