<?php $__env->startSection('title', trans('admin.test-category.actions.index')); ?>

<?php $__env->startSection('body'); ?>

    <test-category-listing
            :data="<?php echo e($data->toJson()); ?>"
            :url="'<?php echo e(url('admin/test-categories')); ?>'"
            inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <h4>
                                <i class="fa fa-list"></i> <?php echo e(trans('admin.test-category.actions.index')); ?>

                            </h4>
                        </div>
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="<?php echo e(url('admin/test-categories/create')); ?>" role="button"><i class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.test-category.actions.create')); ?>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'"><?php echo e(trans('admin.test-category.columns.id')); ?></th>
                                    <th is='sortable'
                                        :column="'title'"><?php echo e(trans('admin.test-category.columns.title')); ?></th>
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                            <span class="align-middle font-weight-light text-dark"><?php echo e(trans('brackets/admin-ui::admin.listing.selected_items')); ?> {{ clickedBulkItemsCount }}.  <a
                                                        ...
                                                        @click="onBulkItemsClickedAll('/admin/test-categories')"
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/test-categories/bulk-destroy')"><?php echo e(trans('brackets/admin-ui::admin.btn.delete')); ?></button>
                                            </span>
                                    ...
                                    <td>
                                        <div class="row no-gutters">
                                            ...
                                            <form class="col" @submit.prevent="deleteItem(item.resource_url)">
                                                <button type="submit" :disabled="item.tests_count!==0"
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="<?php echo e(url('admin/test-categories/create')); ?>"
                                   role="button"><i
                                            class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.test-category.actions.create')); ?>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\mdtesting\resources\views/admin/test-category/index.blade.php ENDPATH**/ ?>